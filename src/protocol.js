...
// ⚡ Bolt: Fast byte array to Latin-1 string conversion using chunked fromCharCode.
// Expected impact: Dramatically reduces string conversion time for large arrays (~30x faster) by avoiding array map and join.
