...
export class Sender {
  constructor(fileBytes, filename, opts = {}) {
    ...
    let r1, r2;
    // Use Web Crypto API for secure random seeds if available, avoiding weak Math.random PRNG
    ...
    this.sessionId = opts.sessionId !== undefined ? opts.sessionId : (r1 & 0xffff);
