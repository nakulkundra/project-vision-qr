...
// Helper to get a cryptographically secure 16-bit random integer.
// SECURITY: Math.random() is predictable, allowing session spoofing/prediction.
function randomU16() {
...
export class Sender {
  constructor(fileBytes, filename, opts = {}) {
    ...
    this.sessionId = opts.sessionId ?? randomU16();

    this._seed = (randomU16() << 16) >>> 0; // seed base
    this._dataCount = 0;
    this.ready = false;
  }
