...
export class Sender {
  constructor(fileBytes, filename, opts = {}) {
    ...
    let r1, r2;
    // Security enhancement: Prevent predictable random number generation (Math.random)
    // which could lead to session collision or stream spoofing. Use crypto API if available.
