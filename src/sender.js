...
// Generate a 16-bit random integer securely, with Math.random fallback
function getRand16() {
...
export class Sender {
  constructor(fileBytes, filename, opts = {}) {
    ...
    // Security: Use Web Crypto for unique session identifiers and protocol seeds
    this.sessionId = opts.sessionId ?? getRand16();
    this._seed = (getRand16() << 16) >>> 0; // seed base
    this._dataCount = 0;
    this.ready = false;
  }
