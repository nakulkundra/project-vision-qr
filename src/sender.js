...
// 🛡️ Sentinel: Use Web Crypto for secure random numbers where available,
// falling back to Math.random() if necessary.
function getRand16() {
...
export class Sender {
  constructor(fileBytes, filename, opts = {}) {
    ...
    this.sessionId = opts.sessionId ?? (getRand16() & 0xffff);
