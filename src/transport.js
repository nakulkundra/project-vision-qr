...
export function decodeBase45(str) {
  ...
  // ⚡ Bolt: Pre-allocate Uint8Array directly instead of pushing to standard array
  // Expected impact: ~4x speedup on base45 decoding by avoiding dynamic array growth
  // and the final Uint8Array.from() cast.
